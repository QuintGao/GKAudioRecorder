...
/**
 停止所有通过startPlayEffectWithPath方法播放的音效
 */
- (void)stopPlayAllEffect;

#pragma mark - 播放背景音乐（不录制，暂不可再录制时播放）
...
/**
 ...
 @param time 指定播放时间
 */
- (void)audioPlaySeekToTime:(float)time;
